...
if (WebComponents.flags.shadow) {
    ...
    (function(scope) {
        ...
        function MutationObserverOptions(options) {
            ...
            if ("characterDataOldValue" in options && !("characterData" in options)) this.characterData = true;
    ...
    (function(scope) {
        ...
        function invoke(currentTarget, event, phase, eventPath, overrideTarget) {
            ...
            for (var i = 0, len = listeners.length; i < len; i++) {
                ...
                try {
                    if (typeof listener.handler === "function") listener.handler.call(currentTarget, event);
            ...
            return function(value) {
                ...
                if (typeof value === "function") {
                    var wrapped = function(e) {
                        ...
                        else if (name === "onbeforeunload" && typeof rv === "string") e.returnValue = rv;
                    };
    ...
    (function(scope) {
        ...
        function cloneNode(node, deep, opt_doc) {
            var clone;
            if (opt_doc) clone = wrap(originalImportNode.call(opt_doc, unsafeUnwrap(node), false));
    ...
    (function(scope) {
        ...
        mixin(HTMLElement.prototype, {
            ...
            set innerHTML(value) {
                ...
                var removedNodes = snapshotNodeList(this.childNodes);
                if (this.invalidateShadowRenderer()) {
                    if (this instanceof wrappers.HTMLTemplateElement) setInnerHTML(this.content, value);
