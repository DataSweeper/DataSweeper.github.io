...
"undefined" == typeof WeakMap && ! function() {
    ...
    function(e) {
        ...
        function c(e) {
            return N ? N : (N = d(y), N.oldValue = e, N)
        }
            ...
            handleEvent: function(e) {
                switch (e.stopImmediatePropagation(), e.type) {
                    ...
                    case "DOMNodeInserted":
                        var s, d, l = e.target;
                        "DOMNodeInserted" === e.type ? (s = [l], d = []) : (s = [], d = [l]);
                        var p = l.previousSibling,
                            m = l.nextSibling,
                            r = u("childList", e.target.parentNode);
                        r.addedNodes = s, r.removedNodes = d, r.previousSibling = p, r.nextSibling = m, i(e.relatedNode, function(e) {
    ...
    function(e) {
        ...
        function i(e, t, n) {
            if (e = window.wrap(e), !(n.indexOf(e) >= 0)) {
                n.push(e);
                for (var o, r = e.querySelectorAll("link[rel=" + a + "]"), s = 0, d = r.length; d > s && (o = r[s]); s++) o["import"] && i(o["import"], t, n);
                t(e)
            }
        }
        ...
        }), e.watchShadow = l, e.upgradeDocumentTree = v, e.upgradeDocument = h, e.upgradeSubtree = o, e.upgradeAll = t, e.attached = a, e.takeRecords = m
    }), window.CustomElements.addModule(function(e) {
        function t(t, o) {
        ...
        function t(t, o) {
            ...
            return d.prototype || (d.prototype = Object.create(HTMLElement.prototype)), d.__name = t.toLowerCase(), d.lifecycle = d.lifecycle || {}, d.ancestry = i(d["extends"]), a(d), s(d), n(d.prototype), c(d.__name, d), d.ctor = f(d), d.ctor.prototype = d.prototype, d.prototype.constructor = d.ctor, e.ready && v(document), d.ctor
        }
        ...
        w = Object.__proto__ || E ? function(e, t) {
            ...
            return !1
        }, m(Node.prototype, "cloneNode"), m(document, "importNode"), h && ! function() {
        ...
        }(), document.registerElement = t, document.createElement = p, document.createElementNS = l, e.registry = N, e["instanceof"] = w, e.reservedTagList = y, e.getRegisteredDefinition = u, document.register = document.registerElement
    }),
    function(e) {
        function t() {
