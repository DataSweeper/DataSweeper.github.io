...
"undefined" == typeof WeakMap && ! function() {
    ...
    function(e) {
        ...
        function u(e) {
            return y ? y : (y = d(L), y.oldValue = e, y)
        }
    ...
    function(e) {
        ...
        function i(e, t) {
            ...
            var s = t.querySelectorAll("link[rel=import]"),
                ...
                l = [];
            if (c)
                for (var h, m = 0; c > m && (h = s[m]); m++) a(h) ? (d++, n()) : (h.addEventListener("load", r), h.addEventListener("error", i));
            else n()
        }
        ...
        function s(e) {
            for (var t, n = 0, r = e.length; r > n && (t = e[n]); n++) d(t) && c(t)
        }
        ...
        l && (new MutationObserver(function(e) {
            ...
            if ("loading" === document.readyState)
                for (var e, t = document.querySelectorAll("link[rel=import]"), n = 0, r = t.length; r > n && (e = t[n]); n++) c(e)
        }()), t(function(e) {
    ...
    function(e) {
        ...
        r.prototype = {
            ...
            receive: function(e, t, n, r, o) {
                this.cache[e] = r;
                for (var i, a = this.pending[e], s = 0, d = a.length; d > s && (i = a[s]); s++) this.onload(e, i, r, n, o), this.tail();
                this.pending[e] = null
            },
            tail: function() {
                ...
                trackElement: function(e, t) {
                    ...
                    if (e.addEventListener("load", r), e.addEventListener("error", r), c && "style" === e.localName) {
                        ...
                        if (-1 == e.textContent.indexOf("@import")) o = !0;
                            ...
                            o = !0;
                            for (var i, a = e.sheet.cssRules, s = a ? a.length : 0, d = 0; s > d && (i = a[d]); d++) i.type === CSSRule.IMPORT_RULE && (o = o && Boolean(i.styleSheet))
                        }
        ...
        var t = e.parser,
            ...
            r = {
                added: function(e) {
                    for (var r, o, i, a, s = 0, d = e.length; d > s && (a = e[s]); s++) r || (r = a.ownerDocument, o = t.isParsed(r)), i = this.shouldLoadNode(a), i && n.loadNode(a), this.shouldParseNode(a) && o && t.parseDynamic(a, i)
                },
