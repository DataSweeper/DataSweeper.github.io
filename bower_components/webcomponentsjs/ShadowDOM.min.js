...
"undefined" == typeof WeakMap && ! function() {
    ...
    function(e) {
        ...
        n.prototype = {
            calcEditDistances: function(e, t, n, r, o, i) {
                ...
                for (var u = 1; a > u; u++)
                    for (var l = 1; s > l; l++)
                        if (this.equals(e[t + l - 1], r[o + u - 1])) c[u][l] = c[u - 1][l - 1];
                        else {
                            var p = c[u - 1][l] + 1,
                                d = c[u][l - 1] + 1;
                            c[u][l] = d > p ? p : d
    ...
    function(e) {
        ...
        function v(e, t, n, r, o) {
            ...
            for (var w = 0, m = i.length; m > w; w++) {
                var g = i[w];
                if (g.removed) h = !0;
                else if (!(g.type !== f || !g.capture && n === oe || g.capture && n === ae)) try {
        ...
        function y(e, t) {
            ...
            var n = e;
            return ve || "beforeunload" !== n.type || this instanceof O ? void B(n, this) : new O(n)
        }
        ...
        var W, I = e.forwardMethodsToWrapper,
            A = e.getTreeScope,
            k = e.mixin,
            F = e.registerWrapper,
            B = e.setWrapper,
        ...
        var ce = S("UIEvent", y),
            ...
            fe = S("MouseEvent", ce, pe),
            he = S("FocusEvent", ce, de),
        ...
        var ve = window.BeforeUnloadEvent;
        O.prototype = Object.create(y.prototype), k(O.prototype, {get returnValue() {
        ...
        var be = window.EventTarget,
            ye = ["addEventListener", "removeEventListener", "dispatchEvent"];
        ...
        var Ee = document.elementFromPoint;
        e.elementFromPoint = x, e.getEventHandlerGetter = R, e.getEventHandlerSetter = P, e.wrapEventTargetMethods = H, e.wrappers.BeforeUnloadEvent = O, e.wrappers.CustomEvent = ue, e.wrappers.Event = y, e.wrappers.EventTarget = L, e.wrappers.FocusEvent = he, e.wrappers.MouseEvent = fe, e.wrappers.UIEvent = ce
    }(window.ShadowDOMPolyfill),
    function(e) {
        "use strict";
    ...
    function(e) {
        ...
        function g(e) {
            if (e.invalidateShadowRenderer()) {
                ...
                for (var n, i = W(e), a = i.firstChild; a;) n = a.nextSibling, Y.call(i, a), a = n
        }
        ...
        S.prototype = Object.create(M.prototype), D(S.prototype, {
            ...
            insertBefore: function(e, n) {
                t(e);
                var r;
                n ? C(n) ? r = W(n) : (r = n, n = A(r)) : (n = null, r = null), n && N(n.parentNode === this);
                var o, s = n ? n.previousSibling : this.lastChild,
                    c = !this.invalidateShadowRenderer() && !v(e);
                if (o = c ? a(e) : i(e, this, s, n), c) f(this, e), m(this), K.call(P(this), W(e), r);
                else {
            ...
            replaceChild: function(e, r) {
                t(e);
                var o;
                if (C(r) ? o = W(r) : (o = r, r = A(o)), r.parentNode !== this) throw new Error("NotFoundError");
    ...
    function(e) {
        ...
        u.prototype = Object.create(w.prototype), v(u.prototype, {get innerHTML() {
                return s(this)
            },
            set innerHTML(e) {
                if (H && C[this.localName]) return void(this.textContent = e);
    ...
    function(e) {
        ...
        var n = e.mixin,
            ...
            d = p.constructor;
        t.prototype = Object.create(p), "instanceRoot" in u && n(t.prototype, {get instanceRoot() {
    ...
    function(e) {
        ...
        if (c) {
            ...
            var u = /WebKit/.test(navigator.userAgent) ? {
                drawingBufferHeight: null,
                drawingBufferWidth: null
            } : {};
            r(c, t, u), e.wrappers.WebGLRenderingContext = t
        }
    }(window.ShadowDOMPolyfill),
    function(e) {
        "use strict";
    ...
    function(e) {
        ...
        function t(e) {
            ...
            var o = e.shadowRoot;
            f.set(this, o), this.treeScope_ = new r(this, a(o || e)), d.set(this, e)
        }
        ...
        t.prototype = Object.create(n.prototype), s(t.prototype, {
            ...
            invalidateShadowRenderer: function() {
                return d.get(this).invalidateShadowRenderer()
            },
    ...
    function(e) {
        ...
        var T, O = e.wrappers.Element,
            ...
            I = new WeakMap,
            A = new WeakMap,
            k = D(window, ["requestAnimationFrame", "mozRequestAnimationFrame", "webkitRequestAnimationFrame", "setTimeout"]),
            F = [],
            B = new P;
            ...
            poolDistribution: function(e, t) {
                if (!(e instanceof j))
                    if (e instanceof N) {
                        ...
                        if (!r)
                            for (var i = n.firstChild; i; i = i.nextSibling) m(i, n)
                    } else
    ...
    function(e) {
        ...
        function n(e) {
            ...
            t.prototype[e] = function() {
                return _(n.apply(j(this), arguments))
            }
        }

        function r(e, t) {
            H.call(j(t), L(e)), o(e, t)
        }
        ...
        var u = e.GetElementsByInterface,
            ...
            m = e.TreeScope,
            g = e.cloneNode,
            v = e.defineWrapGetter,
            b = e.elementFromPoint,
            y = e.forwardMethodsToWrapper,
            E = e.matchesNames,
            S = e.mixin,
            M = e.registerWrapper,
            T = e.renderAllPending,
            O = e.rewrap,
            N = e.setWrapper,
            j = e.unsafeUnwrap,
            L = e.unwrap,
            ...
            D = (e.wrapNodeList, new WeakMap);
        t.prototype = Object.create(l.prototype), v(t, "documentElement"), v(t, "body"), v(t, "head"), ["createComment", "createDocumentFragment", "createElement", "createElementNS", "createEvent", "createEventNS", "createRange", "createTextNode"].forEach(n);
        var H = document.adoptNode,
        ...
        S(t.prototype, {
            ...
            elementFromPoint: function(e, t) {
                return b(this, this, e, t)
            },
            importNode: function(e, t) {
                return g(e, t, j(this))
            },
            getSelection: function() {
                return T(), new f(x.call(L(this)))
            },
        ...
        if (t.prototype.createTreeWalker = function(e, t, n, r) {
                ...
                return n && (n.acceptNode && "function" == typeof n.acceptNode ? o = {
                    acceptNode: function(e) {
                        return n.acceptNode(_(e))
                    }
                } : "function" == typeof n && (o = function(e) {
                    return n(_(e))
                })), new P(R.call(L(this), L(e), t, o, r))
            }, document.registerElement) {
            var W = document.registerElement;
            t.prototype.registerElement = function(t, n) {
                function r(e) {
                    return e ? void N(e, this) : i ? document.createElement(i, t) : document.createElement(t)
                }
                var o, i;
                ...
                ["createdCallback", "attachedCallback", "detachedCallback", "attributeChangedCallback"].forEach(function(e) {
                    var t = o[e];
                    t && (u[e] = function() {
                        _(this) instanceof r || O(this), t.apply(_(this), arguments)
                    })
                });
                var p = {
                    prototype: u
                ...
                W.call(L(this), t, p);
                return r
            }, y([window.HTMLDocument || window.Document], ["registerElement"])
        }
        y([window.HTMLBodyElement, window.HTMLDocument || window.Document, window.HTMLHeadElement, window.HTMLHtmlElement], ["appendChild", "compareDocumentPosition", "contains", "getElementsByClassName", "getElementsByTagName", "getElementsByTagNameNS", "insertBefore", "querySelector", "querySelectorAll", "removeChild", "replaceChild"]), y([window.HTMLBodyElement, window.HTMLHeadElement, window.HTMLHtmlElement], E), y([window.HTMLDocument || window.Document], ["adoptNode", "importNode", "contains", "createComment", "createDocumentFragment", "createElement", "createElementNS", "createEvent", "createEventNS", "createRange", "createTextNode", "createTreeWalker", "elementFromPoint", "getElementById", "getElementsByName", "getSelection"]), S(t.prototype, u), S(t.prototype, p), S(t.prototype, h), S(t.prototype, d), S(t.prototype, {get implementation() {
                var e = D.get(this);
                return e ? e : (e = new a(L(this).implementation), D.set(this, e), e)
            },
            get defaultView() {
                return _(L(this).defaultView)
            }
        ...
        a.prototype.createDocument = function() {
            return arguments[2] = L(arguments[2]), _(I.apply(j(this), arguments))
        }, s(a, "createDocumentType"), s(a, "createHTMLDocument"), c(a, "hasFeature"), M(window.DOMImplementation, a), y([window.DOMImplementation], ["createDocument", "createDocumentType", "createHTMLDocument", "hasFeature"]), e.adoptNodeNoRemove = r, e.wrappers.DOMImplementation = a, e.wrappers.Document = t
    }(window.ShadowDOMPolyfill),
    function(e) {
        "use strict";
