...
define("library-app/templates/blog/index", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "aoADV1pk", "block": "{\"statements\":[[\"open-element\",\"ul\",[]],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"li\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"blog.view\",\"blog/hello-world\"],null,1],[\"close-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"li\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"blog.view\",\"blog/series1\"],null,0],[\"close-element\"],[\"text\",\"\\n     \"],[\"comment\",\" <li>{{#link-to 'blog.view' \\\"blog/bgp\\\"}}Border Gateway Protocol.{{/link-to}}</li> \"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"Django micro practical series I\"]],\"locals\":[]},{\"statements\":[[\"text\",\"hello world\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "library-app/templates/blog/index.hbs" } });
});
