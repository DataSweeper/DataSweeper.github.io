...
window.WebComponents = window.WebComponents || {},
    ...
    function(e) {
        ...
        function i(e, t) {
            ...
            var s = t.querySelectorAll("link[rel=import]"),
                ...
                l = [];
            if (d)
                for (var h, f = 0; d > f && (h = s[f]); f++) a(h) ? (c++, n()) : (h.addEventListener("load", r), h.addEventListener("error", i));
            else n()
        }
        ...
        l && (new MutationObserver(function(e) {
            ...
            if ("loading" === document.readyState)
                for (var e, t = document.querySelectorAll("link[rel=import]"), n = 0, r = t.length; r > n && (e = t[n]); n++) d(e)
        }()), t(function(e) {
    ...
    function(e) {
        ...
        function i() {
            E = !1;
            for (var e, t = L, n = 0, r = t.length; r > n && (e = t[n]); n++) e();
            L = []
        }
        ...
        var _ = e.flags,
            g = e.forSubtree,
            b = e.forDocumentTree,
            y = !window.MutationObserver || window.MutationObserver === window.JsMutationObserver;
        e.hasPolyfillMutations = y;
        var E = !1,
            L = [],
            M = Array.prototype.forEach.call.bind(Array.prototype.forEach),
            T = Element.prototype.createShadowRoot;
        ...
        function f(e, t) {
            ...
            var r;
            return t ? (r = f(e), r.setAttribute("is", t), r) : (r = T(e), e.indexOf("-") >= 0 && b(r, HTMLElement), r)
        }
